...
export default function App() {
  ...
  const [colorChannels, setColorChannels] =
    useState<ColorChannels>(defaultColorChannels);
      ...
      canvasRef.toBlob(
        (blob) => {
          if (blob) {
            ...
            toast.success(
              `Imagem exportada com sucesso em ${format.toUpperCase()}!`,
            );
          }
        },
        mimeType,
        0.95,
      ); // 0.95 é a qualidade para JPEG/JPG
    } catch (error) {
